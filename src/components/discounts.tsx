    ...
    return (
        <section className='py-16 bg-violet-50'>
            <div className='container mx-auto px-3 grid md:grid-cols-2 grid-cols-1 gap-7 items-center'>
                <div>
                    <p className='text-sm font-extrabold text-violet-700 Poppins mb-3'>
                        HughesNet
                    </p>
                ...
                <div>
                    <div className='relative'>
                        <div className='border-2 border-violet-700 rounded-full md:w-[120px] w-[100px] md:h-[120px] h-[100px] flex flex-col items-center justify-center absolute top-1/2 -translate-y-1/2 left-5 -rotate-45'>
                            <p className='md:text-3xl text-xl font-bold text-violet-700 text-center Poppins'> 600</p>
                            <p className='text-sm font-semibold text-violet-700 text-center Poppins'>mbps</p>
                        </div>
                        <Image src="/images/working.png" alt='working' width={1024} height={907} className='w-full object-contain relative z-[1]' />
                        <div className='bg-violet-700 rounded-full md:w-[120px] w-[100px] md:h-[120px] h-[100px] flex flex-col items-center justify-center absolute -top-5 right-5 rotate-12'>
