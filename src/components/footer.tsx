                ...
                <div className="container mx-auto px-3 grid md:grid-cols-4 grid-cols-1 gap-7">
                    <div>
                        ...
                        <ul className='flex flex-wrap gap-1'>
                            <li>
                                <Link href="#" className='flex w-[46px] h-[46px] justify-center items-center bg-gray-600 hover:bg-primary text-white  rounded-[5px]'>
                                    <FaFacebookF />
                                </Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className='flex flex-col gap-4 mt-5'>
                            <li className='flex gap-2 text-base text-white/80 items-center'>
                                <span className='flex min-w-[30px] min-h-[30px] justify-center items-center bg-gray-600 text-primary  rounded-[5px]'>
                                    <FaLocationDot />
