    ...
    return (
        <section className='py-16'>
            <div className='container mx-auto px-3 grid md:grid-cols-2 grid-cols-1 gap-7 items-center'>
                <div className='flex items-center relative md:after:block after:hidden after:absolute after:top-1/2 after:-translate-y-1/2 after:right-0 after:content-[""] after:bg-gradient-to-b after:bg-violet-400 after:via-violet-700 after:from-violet-400 after:h-1/2 after:w-2'>
