        ...
        <section className='py-6 bg-no-repeat bg-cover mt-8' style={{ backgroundImage: `url('/images/upgrade.jpg')`, }}>
            <div className='container mx-auto px-4  items-center '>
                ...
                <div className=' lg:pl-52'>
                    ...
                    <div>
                    <h1 className='text-4xl font-bold text-white Poppins mb-3'>
                    ...
                    <div>
                    <Link href="#" className='flex mt-4 flex-col bg-white w-[230px] m-auto justify-center items-center rounded-full p-2'>
                        <span className='text-xs font-semibold text-primary text-center'>
                            Call to Learn More
                        </span>
                        <span className='sm:text-xl text-sm font-bold text-primary flex gap-1 items-center'>
